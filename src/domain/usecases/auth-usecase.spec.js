...
describe('Auth UseCase', () => {
  ...
  it('should call LoadUserByEmailRepository with correct email', async () => {
    ...
    await sut.auth('any_email@gmail.com', 'password')
  ...
  it('should return null if invalid email is provided', async () => {
    ...
    const accessToken = await sut.auth('invalid_email@gmail.com', 'password')
  ...
  it('should call Encrypter with correct values', async () => {
    ...
    await sut.auth('valid_email@gmail.com', 'password')
  ...
  it('should return accessToken with correct credentials are provided', async () => {
    const { sut, tokenGeneratorSpy } = makeSut()
    const accessToken = await sut.auth('valid_email@gmail.com', 'password')
